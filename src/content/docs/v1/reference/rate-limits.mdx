...
Exact limits vary by model. See the [Plans & Pricing](/v1/plans) page for per-model details, or download the [Service Description PDF](/files/Leistungsbeschreibung-LLM-Serving-Service.pdf).
...
5. **Use the Queue API** — For batch workloads, use [asynchronous requests](/v1/guides/asynchronous-requests) to spread load
