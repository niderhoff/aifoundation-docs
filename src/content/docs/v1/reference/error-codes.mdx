...
- Use the [List Models API](/v1/reference/api-endpoints) to check available models
...
- Check the model's `max_sequence_length` in the [model metadata](/v1/getting-started/models)
