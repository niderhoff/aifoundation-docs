...
- **[LangChain Integration](/v1/integrations/langchain)** — Use embeddings with LangChain for RAG
- **[LlamaIndex Integration](/v1/integrations/llama-index)** — Use embeddings with LlamaIndex for RAG
