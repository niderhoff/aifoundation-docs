...
- OpenAI SDK installed ([Quickstart](/v1/getting-started/quickstart))
...
- [Chat Completions](/v1/guides/chat-completions) — Standard chat API usage
- [Function Calling](/v1/guides/function-calling) — Connect reasoning models to external tools
- [Streaming](/v1/guides/streaming) — Stream reasoning model responses
