...
- A vision-capable model (see [Available Models](/v1/getting-started/models))
:::
...
Check [Available Models](/v1/getting-started/models) for the latest list.
...
- [Visual RAG](/v1/guides/visual-rag) — Index and retrieve from documents with text + image understanding
- [Function Calling](/v1/guides/function-calling) — Connect models to external tools
- [Streaming](/v1/guides/streaming) — Stream responses for better UX
