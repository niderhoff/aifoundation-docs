...
- OpenAI SDK or HTTP client installed ([Quickstart](/v1/getting-started/quickstart))
:::
...
For full streaming documentation including error handling, function calling with streams, and stream options, see the **[Streaming guide](/v1/guides/streaming)**.
...
- [Streaming](/v1/guides/streaming) — Stream responses token-by-token
- [Function Calling](/v1/guides/function-calling) — Connect models to external tools
- [Multimodal](/v1/guides/multimodal) — Analyze images alongside text
- [Asynchronous Requests](/v1/guides/asynchronous-requests) — Queue-based processing for batch workloads
