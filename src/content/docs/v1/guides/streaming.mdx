...
- [Chat Completions](/v1/guides/chat-completions) — Non-streaming chat API usage
- [Function Calling](/v1/guides/function-calling) — Define and use tools with the API
- [Asynchronous Requests](/v1/guides/asynchronous-requests) — Queue-based processing for batch workloads
- [Error Codes](/v1/reference/error-codes) — Handle API errors
