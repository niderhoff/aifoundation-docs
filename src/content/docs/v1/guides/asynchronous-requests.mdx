...
- [Chat Completions](/v1/guides/chat-completions) — Standard synchronous chat API
- [Streaming](/v1/guides/streaming) — Real-time token-by-token responses
- [Rate Limits](/v1/reference/rate-limits) — Understand TPM/RPM limits and headers
- [API Endpoints](/v1/reference/api-endpoints) — Full endpoint reference
