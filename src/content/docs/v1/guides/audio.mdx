...
- [Chat Completions](/v1/guides/chat-completions) — Process transcribed text with LLMs
- [Asynchronous Requests](/v1/guides/asynchronous-requests) — Queue long audio files for async processing
